...
class HashtagsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create hashtag" do
    assert_difference("Hashtag.count") do
      post hashtags_url, params: { hashtag: { name: @hashtag.name, references_count: @hashtag.references_count } }
    end
  ...
  test "should update hashtag" do
    patch hashtag_url(@hashtag), params: { hashtag: { name: @hashtag.name, references_count: @hashtag.references_count } }
